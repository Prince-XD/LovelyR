...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main bot", url="https://t.me/LOVELYR_OBOT"),
        InlineKeyboardButton(
    ...
    msg = f"""
**[Robot ❤️](https://t.me/LOVELY_R0BOTS):**
**MainBot:** `{bot_state}`
**UserBot:** `{ubot_state}`
...
**Profiles:** [BOT](t.me/{BOT_USERNAME}) | [UBOT](t.me/TUSHAR204)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
...
async def music_inline_func(answers, query):
    chat_id = -1001426207683
    group_invite = "https://t.me/LOVELYAPPEAL"
    try:
        messages = [
            m
