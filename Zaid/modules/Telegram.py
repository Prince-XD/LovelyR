...
keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(
                text="Start Me",
                url=f"t.me/Lovelyr_obot?start=session",
            ),
        ]
    ]
)
...
[Add Lovely to your group](https://t.me/Lovelyr_obots?startgroup=true)
**Made With ❤️ By** @Lovely_Robots               
